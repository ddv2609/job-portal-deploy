...
const UserInfo = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`${API_DOMAIN}/api/candidate/info/`, { withCredentials: true });
    ...
    return (
        <div style={userInfoStyle}>
            <div>
                <CandidateAvatar API={{
                    upload: `${API_DOMAIN}/api/candidate/avatar`,
                    delete: `${API_DOMAIN}/api/candidate/avatar`
                }} />
